...
load(file = file.path(workDir, "output/rv144.eset.RData"))
```
...
load(file = file.path(workDir, "output/rv144.esetBaselined.RData"))
```
...
load(file = file.path(workDir, "output/rv144.fits.RData"))
```
